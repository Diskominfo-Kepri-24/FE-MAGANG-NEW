        ...
        <div className="flex flex-col flex-1">
          ...
          <nav className="mt-4 flex-1">
            <ul>
              ...
              <li className="flex items-center p-2 hover:bg-[#03306C]">
                <NavLink to="/pengaturan" className="flex items-center text-white hover:text-blue-300">
        ...
        <div className="flex flex-col flex-1 p-6 overflow-y-auto">
          <div className="text-center w-full max-w-screen-lg mx-auto">
            ...
            <div className="flex flex-col items-center mb-6">
              ...
              <textarea className="w-full h-64 p-2 border mb-4 rounded-md shadow-sm" placeholder="Catatan kegiatan..." value={activity} onChange={(e) => setActivity(e.target.value)} disabled={isSubmitted}></textarea>
              <button className={`bg-blue-600 text-white py-2 px-4 mb-4 rounded-md shadow-sm ${isSubmitted ? 'bg-gray-500 cursor-not-allowed' : ''}`} onClick={handleSubmit} disabled={isSubmitted}>
                ...
                <tbody>
                  {activityList.map((activity, index) => (
                    <tr key={index} className="bg-gray-100 hover:bg-gray-200">
                      ...
                      <td className={`border p-2 text-center ${getStatusBackgroundColor(activity.status)}`}>{activity.status}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
