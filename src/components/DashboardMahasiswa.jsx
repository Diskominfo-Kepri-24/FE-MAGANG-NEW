          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
              <NavLink 
                ...
                className="bg-blue-600 text-white p-6 rounded-lg shadow-md text-center hover:bg-blue-700 transition"
                style={{ width: "100%" }}
              >
              ...
              <NavLink 
                ...
                className="bg-yellow-600 text-white p-6 rounded-lg shadow-md text-center hover:bg-yellow-700 transition"
                style={{ width: "100%" }}
              >
